...
The final XGBoost metrics will be documented here.
...
Multiple evaluation metrics were used because network-failure prediction is an imbalanced classification problem.
